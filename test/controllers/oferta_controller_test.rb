...
class OfertaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ofertum" do
    assert_difference("Ofertum.count") do
      post oferta_url, params: { ofertum: { descripccion: @ofertum.descripccion, titulo: @ofertum.titulo } }
    end
  ...
  test "should update ofertum" do
    patch ofertum_url(@ofertum), params: { ofertum: { descripccion: @ofertum.descripccion, titulo: @ofertum.titulo } }
